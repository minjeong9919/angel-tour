...
export const Sidebar = () => {
  return (
    <div className='min-w-[400px] max-w-[400px] mt-30 font-jua'>
      ...
      <div className='relative w-full min-h-[calc(2250px*4)]'>
        <div className='bg-white p-4 rounded-lg shadow-custom-md sticky top-22 mb-2 flex flex-col gap-1 text-sm'>
          <h3 className='text-base text-primary'>2,3,4,5일차</h3>
      ...
      <div className='relative w-full min-h-[calc(735px)]'>
        <div className='bg-white p-4 rounded-lg shadow-custom-md sticky top-22 mb-2 flex flex-col gap-1 text-sm'>
          <h3 className='text-base text-primary'>6일차</h3>
