...
export default function Myanmar() {
  return (
    <div>
      ...
      <div className='w-[100vw] pt-40 pb-20 px-10 flex-col bg-white relative'>
        <div
          className={`absolute right-0 top-0 w-[60%] h-[100%] bg-gradient-to-r from-white from-20% to white to-100% z-1`}
        />
        <Image
          src={MYANMAR1}
      ...
      <div className='w-[100vw] pt-40 pb-20 px-10 flex-col bg-primary-50 text-right relative'>
        <div
        ...
        <div className='relative z-4 ml-auto'>
          ...
          <h6 className='text-lg w-[70%] ml-auto'>
            ...
            그렇기 때문에 치안과 관광에 좋은 나라입니다. <br /> 또한 양곤은
            젋은의 나라인만큼 발전 가능성이 굉장히 높아요.
          </h6>
        </div>
      </div>
      <div className='w-[100vw] pt-40 pb-20 px-10 flex-col bg-white text-left bg-primary-50 relative'>
        <div
          className={`absolute right-0 top-0 w-[60%] h-[100%] bg-gradient-to-r from-white from-20% to white to-100% z-1`}
        />
        <Image
          src={MYANMAR3}
          className='absolute right-0 top-0 h-[100%] w-[60%] z-0'
          alt='Pixabay로부터 입수된 HeungSoon님의 이미지 입니다.'
        />
        <div className='relative z-4 w-[70%]'>
          <h4 className='text-5xl font-extrabold mb-5'>
          ...
          <h6 className='text-lg '>
            골프 여행과 더불어 다양한 매력을 지닌 여행지이지만, <br /> 한국에
            많이 알려지지 않아 한국사람이 별로 없으며, 골프장의 컨디션도
            좋습니다.
            <br />
            그렇기 때문에 무엇보다도 합리적인 가격에 호텔의 숙박과, 그린피,
            카트피, 캐디비, 세탁 등 다양한 서비스를 받을 수 있습니다.
          </h6>
        </div>
      </div>
      <div className='w-[100vw] pt-40 pb-20 px-10 flex-col  text-right bg-primary-50 relative'>
        <div
          className={`absolute left-0 top-0 w-[60%] h-[100%] bg-gradient-to-l from-primary-50 from-20% to white to-100% z-1`}
        />
        <Image
        ...
        <div className='relative z-4 ml-auto'>
          ...
          <h6 className='text-lg w-[70%] ml-auto'>
            ...
            세계적으로 유명한 역사적 장소들로, 이곳에서 미얀마의 역사와 문화를
            깊이 이해하고 느낄 수 있습니다.
            <br /> 또한, 미얀마는 아직 개발이 덜 된 지역이 많아, 독특하고
            전통적인 분위기를 경험할 수 있는 기회를 제공합니다.
          </h6>
        </div>
      </div>
    </div>
