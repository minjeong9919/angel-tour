...
import MainImage4 from "@/app/_assets/images/main4.jpeg";
  ...
  return (
    <figure className='bg-gray-700 relative min-w-screen h-[100%] flex flex-col justify-center items-center'>
      ...
      <div
        className={`${
          imageNum === 2 ? "animate-slide-to-left" : ""
        } text-white z-1 w-fit flex flex-col gap-7 h-[280px] text-left ml-110`}
      >
        <h1 className='text-7xl font-extrabold mt-5'>미얀마의 옛 수도, 양곤</h1>
        <h6 className='text-2xl'>
          YCDC, 양곤, 다곤 오클라 CC 포함된 코스
          <br />
          미얀마의 역사와 문화를 품은 항구도시 양곤에서 상징적인 건축물들의
          웅장함을 느껴보세요.
        </h6>
      </div>
    </figure>
