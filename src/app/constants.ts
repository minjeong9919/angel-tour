...
export const FAQ = [
  {
    q: "미얀마 양곤 골프여행 패키지는 몇 일간 진행되나요?",
    a: "본 패키지는 5박 6일이지만 원하는 일정으로 얼마든지 조율 가능합니다.",
  },
  {
    q: "방문하게 될 골프장은 어디어디 인가요?",
    a: "YCDC, 다곤, 양곤, 오클라CC 네 곳의 골프장을 방문하게 되며, 각 골프장마다 특색있는 코스를 즐길 수 있습니다.",
  },
  {
    q: "숙박하게 될 호텔은 어떤 곳인가요?",
    a: "패키지 이용 시 5성급의 멜리아 또는 세도나 호텔로 현지 사정에 따라 동일 5성급으로 변동될 수 있습니다.",
  },
  {
    q: "혼자 예약도 가능한가요?",
    a: "양곤 관광만 신청하셔도 전일정 동반가능합니다.",
  },
];
